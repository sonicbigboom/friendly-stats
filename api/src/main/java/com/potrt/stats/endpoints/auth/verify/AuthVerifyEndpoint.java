/* Copyright (c) 2024 */
package com.potrt.stats.endpoints.auth.verify;
...
@Controller
public class AuthVerifyEndpoint {
  private VerificationService verificationService;

  /** Autowires a {@link AuthVerifyEndpoint}. */
  public AuthVerifyEndpoint(VerificationService verificationService) {
